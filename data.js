      ...
      topics: [
        {
          ...
          projects: [
            { text: '<strong>Rolling 7-day call volume</strong> — Use your Petpooja call log data. Write a CTE that calculates daily call counts, then query it to get 7-day rolling sums per agent.' },            { text: '<strong>E-commerce funnel analysis</strong> — Olist dataset. CTE layer 1: sessions per user. CTE layer 2: purchases per user. Final: conversion rate per category.' },
